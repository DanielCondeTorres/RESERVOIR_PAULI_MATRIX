# ⚛️ Hamiltonian Implementations (hamiltonian.jl)
...
**Physics:** Used to study standard quantum phase transitions (Ferromagnetic ↔ Paramagnetic).
...
# ⚛️  Pauli Operators and Bitmask Algebra (pauli.jl)
